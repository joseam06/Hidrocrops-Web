...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <a href="{{ route('modules.index') }}" class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-medium">Módulos disponibles</h3>
                </div>
            </a>
        ...
        <div class="text-center">
            ...
            <a href="{{ route('explore') }}" class="inline-block bg-green-800 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg transition-colors">
                Explorar Hidroponía
            </a>
        </div>
    </div>
